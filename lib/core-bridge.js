...
const SPEECH_RUNTIME_RELATIVE_PATH = "./plugin-sdk/speech-runtime.js";
...
function loadOpenClawSpeechRuntime() {
  ...
  for (const anchor of anchors) {
    try {
      ...
      const runtime = runtimeRequire(SPEECH_RUNTIME_RELATIVE_PATH);
      if (runtime?.synthesizeSpeech && typeof runtime.resolveTtsConfig === "function") {
        return runtime;
      }
    } catch {
      // 当前入口不是 OpenClaw runtime 时，继续尝试其他候选位置。
    }
  }
